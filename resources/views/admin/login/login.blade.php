        ...
        <div class="row justify-content-center">
            ...
            <div class="col-xl-10 col-lg-12 col-md-9">
                    ...
                    <!-- Nested Row within Card Body -->
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card o-hidden border-0 shadow-lg my-5 mx-auto" style="width: 400px;">
                                ...
                                <div class="p-5">
                                    ...
                                    <div class="form-group">
                                        {{ Form::email('email', $value =null, ['class' => 'form-control', 'placeholder' => 'Enter your email address...']) }}
                                    </div>
